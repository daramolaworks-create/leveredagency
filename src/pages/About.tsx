      ...
      <section className="relative px-5 pb-16 pt-32 sm:px-8 md:pt-40 lg:px-10">
        ...
        <div className="relative mx-auto grid max-w-[1480px] grid-cols-1 gap-6 lg:grid-cols-[1fr_0.72fr]">
          ...
          <motion.div
            ...
            className="relative min-h-[520px] overflow-hidden rounded-[36px] bg-black"
          >
            <img src="/images/team-about-global.png" alt="" className="absolute inset-0 h-full w-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6 rounded-[26px] border border-white/15 bg-white/14 p-5 text-white backdrop-blur-md">
              <Globe2 size={24} className="text-brand-yellow" />
              <p className="mt-8 text-3xl font-semibold">Global by design</p>
